...
import { Phone, CheckCircle, XCircle, Lock, ArrowUp, ArrowDown, MapPin, AlertTriangle, HelpCircle } from 'lucide-react';
...
export const PackageItem: React.FC<PackageItemProps> = ({ 
  ...
  // Jeśli locationConfidence jest undefined, zakładamy 1.0 (legacy data)
      ...
      `}>
        ...
        <div className="flex justify-between items-start mb-2">
          <div className="w-full">
            ...
            <h3 className={`text-sm font-semibold leading-tight ${confidence === 0.0 ? 'text-red-300 italic' : 'text-gray-200'}`}>
               {pkg.address}
            </h3>
